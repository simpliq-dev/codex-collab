...
- Bundled the portable `markdown-collab` skill inside the VSIX.
- Added a guided skill installer with user-profile and workspace scopes for Codex, Cursor, and Claude Code.
- Added a directly downloadable `SKILL.md` asset to GitHub Releases.
